...
int main() {
    ...
    for(i = 0; i < n_data/step; ++i)
    {
        ...
        vres = vaddq_u8(vres,va[0]);
        vres = vaddq_u8(vres,va[1]); 
        vres = vaddq_u8(vres,va[2]);  
        vres = vaddq_u8(vres,va[3]);  
        vres = vaddq_u8(vres,va[4]);  
        vres = vaddq_u8(vres,va[5]);  
        vres = vaddq_u8(vres,va[6]);  
        vres = vaddq_u8(vres,va[7]);
